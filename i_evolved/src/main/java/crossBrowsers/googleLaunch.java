package crossBrowsers;
	...
	public class googleLaunch {
	    ...
	    public void SelectBrowser(String browser)
	    {
	        ...
	        if (browser.equalsIgnoreCase("ChromeHeadLess")) {
	          ...
	          caps.setCapability(PhantomJSDriverService.PHANTOMJS_EXECUTABLE_PATH_PROPERTY, "/project/challenge/phantomjs-2.1.1-linux-x86_64/bin/phantomjs");
	          driver=new PhantomJSDriver(caps);
	          System.out.println("PhantomJS Headless Driver launched");
	         
	        }
	     
	       // F:\GAURAV\eclips_ssd\i_evolved\.\project\challenge\phantomjs-2.1.1-linux-x86_64\bin\phantomjs
	...
	//./project/challenge/phantomjs-2.1.1-linux-x86_64/bin/phantomjs
