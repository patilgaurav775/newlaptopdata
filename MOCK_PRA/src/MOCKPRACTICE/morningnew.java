...
public static void odd_even_count(int L,int R) {	//1,5
...
public static void colour_test() {
	...
	String act=button.getCssValue("background-color");
	
	System.out.println(act);
	
	String actual=Color.fromString(act).asHex();
	String expected="#17a954";
...
public static int i=1;
	public static void without_for_loop_123() {
		if (i<=100) {
	...
	public static void withou_for_loop_123(int n) {
		if (n<=100) {
			System.out.print(n+" ");
		
		withou_for_loop_123(n+1);
		}
	...
	public static void without_loop_print_star_() {
		System.out.println("*\n**\n***\n");
	}
	...
	public static void main(String[] args) {
		morningnew name = new morningnew();
			...
			//odd_even_count(1, 5);
			//colour_test();
			//without_for_loop_123();
			//withou_for_loop_123(1);
			//ternary_operator();
			//without_loop_print_star_();
